...
<Route path="/" element={<AdminPage addEvent={addEvent} mode={state.mode} editauc={state.editauc} editEvent={editEvent}
 list={state.list} removeEvent={removeEvent} changeToEditMode={changeToEditMode}/>}/>
